...
export const getActivateCreatorUrl = () => {




  return `/api/profiles/me/creator`
}

/**
 * @summary Self-activate creator membership
 */
export const activateCreator = async ( options?: RequestInit): Promise<Profile> => {

  return customFetch<Profile>(getActivateCreatorUrl(),
  {
    ...options,
    method: 'POST'
...
export const getActivateCreatorMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof activateCreator>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof activateCreator>>, TError,void, TContext> => {

const mutationKey = ['activateCreator'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof activateCreator>>, void> = () => {


          return  activateCreator(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ActivateCreatorMutationResult = NonNullable<Awaited<ReturnType<typeof activateCreator>>>

    export type ActivateCreatorMutationError = ErrorType<void>

    /**
 * @summary Self-activate creator membership
 */
export const useActivateCreator = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof activateCreator>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof activateCreator>>,
        TError,
        void,
        TContext
      > => {
      return useMutation(getActivateCreatorMutationOptions(options));
    }
